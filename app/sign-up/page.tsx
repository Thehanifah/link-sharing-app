        ...
        >
          ...
          <div className="flex flex-col w-[full] items-start gap-6 self-stretch">
            ...
            <div className="w-full">
              ...
              <div className={`input-container border border-borders  flex items-center w-auto sm:w-[396px] py-3 px-4 ${passwordLengthError? 'border-red-500' : 'border-borders'} bg-white-custom rounded-lg p-4`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="w-full">
              ...
              <div className= {`input-container flex items-center w-[auto] sm:w-[396px] py-3 px-4 border border-borders bg-white-custom rounded-lg p-4 ${passwordMismatch? 'border-red-500' : 'border-borders'}`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
