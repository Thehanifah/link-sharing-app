...
<p className={`text-dark-grey font-instrument-sans text-12px font-normal leading-18px ${emailError ? 'text-red-500' : 'text-dark-grey' } `}>
Email
</p>

<div className={`input-container border border-borders  flex items-center w-auto sm:w-[396px] py-3 px-4 ${emailError ? 'border-red-500' : 'border-borders'} bg-white-custom rounded-lg p-4`}>
<svg
...
<div className="w-full">
<p className= {`text-dark-grey font-instrument-sans text-12px font-normal leading-18px ${passwordError ?  'text-red-500' : 'text-dark-grey'  }`}>
Password
</p>

<div className={`input-container border border-borders  flex items-center w-auto sm:w-[396px] py-3 px-4 ${passwordError ? 'border-red-500' : 'border-borders'} bg-white-custom rounded-lg p-4`}>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className='mr-3'>
...
{passwordError && <p className="font-instrument-sans text-[12px] w-[162px] font-normal leading-[18px] text-nowrap  text-red-500"> Please check again</p>}
 ...
 <div className="flex items-center justify-between w-full">
  <button
        ...
        <p
    className="text-base font-normal leading-loose text-[16px] text-[#737373] font-Instrument Sans text-center self-center w-[200px] sm:w-full">
    Don’t have an account? <Link href="/sign-up" className='text-[#633CFF]'>Create account</Link>
  </p>
 </div>
